...
function path_consider()
	...
	if locl.room_relation=='南疆沙漠' then        
                    exe('look;discard letter;stop;hp;drink jiudai;ne')   
             quick_locate=0					
               return checkWait(goContinue,1.0)
           end
...
function searchPre()
  ...
  if job.name and job.name=='wudang' and flag.times==1 then
       l_distance = 4
  end
...
duCjiang_start=function()
	...
	if ll_place and ll_place == '大理城南澜沧江边' then return end
       EnableTriggerGroup("dujiang",true)
...
function locateroom(where)
 ...
 bohuacong=function()
            exe('opendoor;whisper startd 开门')
...
------------------------------佛山英雄客栈----------------------------------------
fushankedian=function()
	exe('give xiao 5 silver;up')
	return checkWait(fushankedian1,0.15)
end
fushankedian1=function()
   if flag.find==1 then return end
   exe('enter')
   return checkWait(fushankedian2,0.15)
end
fushankedian2=function()
   if flag.find==1 then return end
   exe('out')
   return walk_wait()
end
fskdoutgo=function()
	EnableTriggerGroup("fskedianout",false)
	DeleteTriggerGroup("fskedianout")
	exe('out;down;e')
	return walk_wait()
end

fskedianoutgosleep=function()
	exe('east')
	fastLocate()
	wait.make(function() 
        wait.time(0.3)
		if flag.find==1 then return end
		return fskedianoutgosleepdo()
	end)
end
fskedianoutgosleepdo=function()
	locate_finish=0
	DeleteTriggerGroup("fskedianout")
	create_trigger_t('fskedianout1','^>*\\s*你一觉醒来，觉得精力充沛，该活动一下了。$','','fskdoutgo') 
	create_trigger_t('fskedianout2','^>*\\s*怎么着，想白住啊！$','','fskzgogo') 
	SetTriggerOption("fskedianout1","group","fskedianout")
	SetTriggerOption("fskedianout2","group","fskedianout")
	if locl.room_relation=='客店二楼〓英雄客栈-----佛山南街' then
	   exe('up;enter;sleep')
	else
	   return fskzgogogo()
	end
...
hckzcheck=function()
	if flag.find==1 then return end
	DeleteTriggerGroup("hckz")
	create_trigger_t('hckz1','^>*\\s*你一觉醒来，觉得精力充沛，该活动一下了。$','','hckzoutgo') 
	create_trigger_t('hckz2','^>*\\s*怎么着，想白住我们鸿昌客栈啊！$','','hckzoutgogogo') 
	SetTriggerOption("hckz1","group","hckz")
	SetTriggerOption("hckz2","group","hckz")
    if locl.room_relation=='客店二楼〓岳王庙---鸿昌客栈---青石官道鸿昌客栈' then
		exe('up;enter;sleep')
	else
		return hckzoutgogo()
    end
...
hckzoutgo=function()
	EnableTriggerGroup("hckz",false)
	DeleteTriggerGroup("hckz")
    exe('out;d;w')
	return walk_wait()
end
hckzoutgogogo=function()
	EnableTriggerGroup("hckz",false)
	DeleteTriggerGroup("hckz")
	exe('w')
	return walk_wait()
end
hckzoutgogo=function()
	EnableTriggerGroup("hckz",false)
	DeleteTriggerGroup("hckz")
	return walk_wait()
end
...
czkz=function()
	exe('give xiao 5 silver;up')
	return checkWait(czkz1,0.15)
end
czkz1=function()
   if flag.find==1 then return end
   exe('enter')
   return checkWait(czkz2,0.15)
end
czkz2=function()
   if flag.find==1 then return end
   exe('out')
...
czkzcheck=function()
	if flag.find==1 then return end
	DeleteTriggerGroup("czkz")
	create_trigger_t('czkz1','^>*\\s*你一觉醒来，觉得精力充沛，该活动一下了。$','','czkzoutgo') 
	create_trigger_t('czkz2','^>*\\s*店小二一下挡在楼梯前，白眼一翻：怎麽着，想白住啊！$','','czkzoutgogogo') 
	SetTriggerOption("czkz1","group","czkz")
	SetTriggerOption("czkz2","group","czkz")
    if locl.room_relation=='客店二楼〓北街---大客栈---南街大客栈' then
		exe('up;enter;sleep')
	else
		return czkzoutgogo()
    end
...
czkzoutgo=function()
	EnableTriggerGroup("czkz",false)
	DeleteTriggerGroup("czkz")
    exe('out;d;n')
	return walk_wait()
end
czkzoutgogogo=function()
	EnableTriggerGroup("czkz",false)
	DeleteTriggerGroup("czkz")
	exe('n')
	return walk_wait()
end
czkzoutgogo=function()
	EnableTriggerGroup("czkz",false)
	DeleteTriggerGroup("czkz")
	return walk_wait()
end
