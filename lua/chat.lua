...
chat_trigger=function()
	...
	create_triggerex_lvl('chat8',"^(> )*(\\! )*【谣言】某人：据说有人看到财神在(\\D*)出现",'','rumor_cs',98)
	create_trigger_t('chat9',"^(> )*(\\! )*【活动公告】据说有人看到财神爷在(\\D*)附近出现了",'','rumor_cs_wz')
	create_trigger_t('chat10',"^(> )*(\\! )*【活动公告】书剑永恒天玑站砸金蛋活动开始了",'','rumor_zaegg')
	
	create_trigger_t('chat2',"^(> )*("..dekelllogtemp..")",'','color_chats')
	...
	SetTriggerOption("chat10","group","chat")
end
