...
nbkz=function()
	exe('give xiao 5 silver;up')
	return checkWait(nbkz1,0.15)
end
nbkz1=function()
   if flag.find==1 then return end
   exe('enter')
   return checkWait(nbkz2,0.15)
end
nbkz2=function()
   if flag.find==1 then return end
   exe('out;d;n')
...
return checkWait(eyu_check,3)
else
return checkWait(eyu_finish,3)
end
end
corpse_check=function()
DeleteTriggerGroup("corpse_check")
create_trigger_t('corpse_check1',"^>*\\s*(\\D*)的尸体\\(Corpse\\)$",'','eyu_finish')
SetTriggerOption("corpse_check1","group","corpse_check")
EnableTriggerGroup("corpse_check",true)
wait.make(function()
       wait.time(4)
return kill_yu()
end)
...
function eyu_finish()
EnableTriggerGroup("corpse_check",false)
checkWait(locate,2)
